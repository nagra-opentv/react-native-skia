...
class TVEventHandler {
  ...
  enable(component: ?any, callback: Function): void {
    ...
    console.log('Before calling NativeEventEmitter: ', NativeEventEmitter, NativeTVNavigationEventEmitter);
    this.__nativeTVNavigationEventEmitter = new NativeEventEmitter(
      NativeTVNavigationEventEmitter,
    );
    console.log('Emitter created: ', this.__nativeTVNavigationEventEmitter);
